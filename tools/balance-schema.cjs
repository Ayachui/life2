...
const PARAMS = [
  ...
  p("arcade.arcadeEnd.chainSustainGens", "цепочка", "Столько циклов подряд с зайцами = устойчивая цепочка (открывает медведя и потолок ⚡).", { sheet: "Конец_раунда", unit: "циклов" }),
